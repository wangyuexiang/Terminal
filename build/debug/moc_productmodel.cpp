...
const QMetaObject ProductModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_ProductModel.data,
      qt_meta_data_ProductModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ProductModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProductModel.stringdata0))
        return static_cast<void*>(const_cast< ProductModel*>(this));
